...
final class ProfileViewController: UIViewController {
    ...
    required init?(coder: NSCoder) {
        profileModel = ProfileControllerModel(profileImage: #imageLiteral(resourceName: "Снимок экрана 2021-11-08 в 2.48.26 PM"),
                                              nameString: "Alexa",
                                              interestsString: "Games",
                                              addressLabel: "Minsk",
                                              followersCount: "10",
                                              followingCount: "5",
                                              postsCount: "0",
                                              photos: [#imageLiteral(resourceName: "Снимок экрана 2021-11-03 в 8.28.10 PM"), #imageLiteral(resourceName: "Снимок экрана 2021-11-03 в 10.35.40 PM"), #imageLiteral(resourceName: "Снимок экрана 2021-11-03 в 10.35.14 PM"), #imageLiteral(resourceName: "Снимок экрана 2021-11-03 в 10.36.15 PM"), #imageLiteral(resourceName: "Снимок экрана 2021-11-03 в 8.29.09 PM"), #imageLiteral(resourceName: "Снимок экрана 2021-11-03 в 8.30.27 PM")])
...
extension ProfileViewController: ProfilePhotosCellDelegate {
    func photoSelected(_ photo: UIImage) {
        let controller = FullPhotoNewController(name: "Alexa",
